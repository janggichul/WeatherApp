export default function CommunityCode() {
  return (
    <div className="">
      <div className="">
        <div className="flex items-center justify-between px-2 pt-3 ml-1 font-bold text-lg text-gray-700">
          <div>게시글</div>
        </div>
        <div className="mt-2">
          <div className="flex w-full flex-col overflow-y-scroll">
            ...
            <h3 className="flex items-center justify-between px-2 pt-3 ml-1 font-bold text-lg text-gray-700">
              테스트
            </h3>
            <div className="mt-2">
              <button className="group flex items-center gap-x-5 rounded-md px-2.5 py-2 transition-all duration-75 hover:bg-green-100">
